...
This document outlines the workflow for developing the `wraider` project.

**Project Files:**
*   **Project Overview:** `/Users/jimmytheghost/AI-Local-Stack/wraider/readme.md`
...
**Familiarization:** Before beginning work, please read all files within the project structure to understand the current state.
